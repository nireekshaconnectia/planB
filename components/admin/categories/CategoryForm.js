...
export default function CategoryForm({ onSave, initialData = null, onClose }) {
    ...
    const [formData, setFormData] = useState({
        ...
        image: null,
        imagePreview: initialData?.imageUrl ? formatImageUrl(initialData.imageUrl) : ''
    });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const url = initialData 
                ? `${process.env.NEXT_PUBLIC_API_URL}/categorey/${initialData.id}`
                : `${process.env.NEXT_PUBLIC_API_URL}/categorey`;
